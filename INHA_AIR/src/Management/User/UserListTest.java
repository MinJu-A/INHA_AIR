...
public class UserListTest extends JFrame implements ActionListener {
	// Title 및 사이즈 설정
	...
	//메뉴
		...
		private JButton btnLogo, btnUser, btnAirway, btnAirport, btnPay, btnLogout;
	...
	private String[] uTableTitle = {"아이디", "패스워드","이름", "성별", "여권번호", "생년월일","전화번호", "이메일"};
